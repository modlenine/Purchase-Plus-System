            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label><b>รหัสสินค้า</b></label>{{ dataareaid }}
                        <input
                            type="text"
                            class="form-control"
                        ...
                        <div class="card-box height-100-p pd-20">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="ip-cpv-areaid" id="ip-cpv-areaid" class="form-control" v-model="dataareaid" disabled>
                                ...
                                <div v-if="imageFiles.length > 0" class="mt-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        ...
                                        />
                                        <button class="btn btn-sm btn-danger mt-1 btn-block" @click="confirmDeleteFile(img)">ลบไฟล์</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div v-if="pdfFiles.length > 0" class="mt-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        ...
                                        >
                                            ...
                                            <button class="btn btn-sm btn-danger mt-1" @click="confirmDeleteFile(pdf)">ลบไฟล์</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3 form-group" v-if="selectedVendorIndex !== null">
                                    <div class="col-md-3 form-group-sm">
                                        ...
                                        <input type="text" name="ip-userpost" id="ip-userpos" class="form-control" readonly :value="this.userData.Fname+' '+this.userData.Lname">
                                    </div>
                                    <div class="col-md-3 form-group-sm">
                                        <label for=""><b>แผนก</b></label>
                                        <input type="text" name="ip-dept" id="ip-dept" class="form-control" readonly :value="this.userData.Dept">
                                    </div>
                                    <div class="col-md-3 form-group-sm">
                                        <label for=""><b>รหัสพนักงาน</b></label>
                                        <input type="tel" name="ip-ecode" id="ip-ecode" class="form-control" readonly :value="this.userData.ecode">
                                    </div>
                                    <div class="col-md-3 form-group-sm">
                                        <label for=""><b>วันที่ร้องขอ</b></label>
                                        <input type="text" name="ip-datetimecreate" id="ip-datetimecreate" class="form-control" readonly :value="docdatetime">
                                    </div>
                                </div>
                                <hr>
