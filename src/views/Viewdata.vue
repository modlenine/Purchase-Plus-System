            ...
            <div class="pd-ltr-20">
                        ...
                        <div class="card-box height-100-p pd-20">
                            ...
                            <div class="row form-group">
                                <div class="col-md-4 form-group">
                                    ...
                                    <select name="ip-cpr-areaid" id="ip-cpr-areaid" class="form-control" v-model="dataareaid" disabled>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="ip-cpr-reqplan" id="ip-cpr-reqplan" v-model="plantype" disabled>
                                        <option value="">กรุณาเลือกรายการ</option>
                                    </select>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for=""><b>หมวดหมู่สินค้า</b></label>
                                    <select class="form-control" name="ip-cpr-itemcategory" id="ip-cpr-itemcategory" v-model="itemcategory" disabled>
                                        <option value="">กรุณาเลือกรายการ</option>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="ip-cpr-costcenter" id="ip-cpr-costcenter" v-model="costcenter" disabled>
                                        <option value="">กรุณาเลือกรายการ</option>
                                    </select>
                                </div>
                                <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-4 fo">
                                    ...
                                    <select class="form-control" name="ip-cpr-ecodereq" id="ip-cpr-ecodereq" v-model="ecode" disabled>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="ip-cpr-vendemail" id="ip-cpr-vendemail" class="form-control" disabled v-model="vendemail">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="ip-cpr-docDatetime" id="ip-cpr-docDatetime" class="form-control" disabled :value="datetimecreate">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for=""><b>วันที่ขอซื้อ</b></label>
                                    <input type="text" name="ip-cpr-reqDatetime" id="ip-cpr-reqDatetime" class="form-control" disabled :value="datetimereq">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for=""><b>วันที่ส่งของ</b></label>
                                    <input type="text" name="ip-cpr-recDatetime" id="ip-cpr-recDatetime" class="form-control" disabled :value="datetimedelivery">
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for=""><b>หมายเหตุ</b></label>
                                    <textarea name="ip-cpr-memo" id="ip-cpr-memo" cols="30" rows="10" class="form-control" v-model="memo" disabled></textarea>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row form-group">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="ip-cpr-userpost" id="ip-cpr-userpost" class="form-control" disabled :value="userpost">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for=""><b>รหัสพนักงาน</b></label>
                                    <input type="text" name="ip-cpr-userecode" id="ip-cpr-userecode" class="form-control" disabled :value="ecodepost">
                                </div>
                                <div class="col-md-4 form-group">
                ...
                <div v-if="showmgrpage">
                    <Mgrpage
                        :formno="this.formno"
                        :status="this.status"
                        :userpostMgr_prop="this.userpostMgr"
                        :ecodepostMgr_prop="this.ecodepostMgr"
                        :datetimepostMgr_prop="this.datetimepostMgr"
                        :approveMgr_prop="this.approveMgr"
                        :sumprice_prop="this.sumprice"
                ...
                <div v-if="showPurPage">
                    <Purpage
                        :formno_prop="this.formno"
                        :status="this.status"
                        :datetimenow_prop="this.datetimenow"
                        :approve_pur_prop="this.approve_pur"
                ...
                <div v-if="showPoPage">
                    <Popage
                        :pono_prop="this.pono"
                        :prno_prop="this.prno"
                        :areaid_prop="this.dataareaid"
                        :department_prop="this.department"
                        :formno="this.formno"
                        :ecode="this.ecode"
