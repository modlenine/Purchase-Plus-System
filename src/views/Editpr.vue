                        ...
                        <div class="card-box height-100-p pd-20">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 form-group">
                                    ...
                                    <router-link :to="{name:'Viewdata' , params:{formno:formno}}" type="button" id="btn-backtoView" class="btn btn-secondary"><i class="dw dw-undo2 mr-2"></i>ย้อนกลับ</router-link>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-12 form-group">
                                    <button type="submit" class="btn btn-warning"><i class="dw dw-diskette1 mr-2"></i>บันทึกการแก้ไข</button>
                                </div>
                            </div>
        ...
        saveDataAll_edit()
        {
            ...
            if(this.dataareaid == ""){
                ...
                if(parseFloat(itemsumpriceTotalPlus) > parseFloat(proxy.payGroupMaxprice)){
                    ...
                    axios.post(this.url+'intsys/purchaseplus/purchaseplus_backend/mainapi/saveDataAll_edit' , formdata ,{
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    }).then(res=>{
